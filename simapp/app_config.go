...
import (
	...
	groupmodulev1 "cosmossdk.io/api/cosmos/group/v1/module/v1"
...
var BindingConfig = depinject.Configs(
	AppConfig,
	depinject.BindInterfaceFromGo(new(banktypes.AccountKeeper), new(*authkeeper.AccountKeeper)))
